...
/*
 * NOTE: Rename the test_test.go file to test_test.go.txt first and then rename this file to test_test.go to run tests present here.
 */
...
func TestDeaf(t *testing.T) {
	...
	pxa[0].Start(1, "xxx")
	waitn(t, pxa, 1, npaxos-1, []string{"goodbye"})
	time.Sleep(1 * time.Second)

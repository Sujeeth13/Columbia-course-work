...
{
	static const struct sched_param param = { .sched_priority = OVEN_MAX_WEIGHT };
	 ...
	 */
	sched_setscheduler_nocheck(current, SCHED_OVEN, &param);
 ...
 * it.  See also kthread_run().  The new thread has SCHED_OVEN policy and
